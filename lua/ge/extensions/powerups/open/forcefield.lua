...
local M = {
	...
	leveling = {"forcefield 1", "forcefield 2", "forcefield 3"},
...
M.onCreate = function(trigger)
	...
	return {
		trigger = trigger,
		marker = Extender.defaultPowerupCreator(trigger, "art/shapes/collectible/s_collect_gear.cdae", Point4F(0, 0, 1, 1)),
		vehicle = nil
	}
end
