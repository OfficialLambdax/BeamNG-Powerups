...
local function onDefaultForceFieldReaction(origin_vehicle, target_vehicle, settings)
	...
	local push = ((vel1 - vel2) + (pos2 - pos1)) * 0.8
...
local set = {
	...
	{"", {spectate = false}, "GE", 0, 1, ForceField.addVehicle, "ve_target", 7, {timer = nil, time = 30000, state = true, state_change = nil, step = 0}, onDefaultForceFieldReaction, offDefaultForceFieldReaction, createMarker, updateMarker, destroyMarker},
	{"", {spectate = false}, "GE", 30000, 1, ForceField.remVehicle, "ve_target"},
