...
local M = {
	...
	leveling = {"shockwave 1", "shockwave 2", "shockwave 3"},
...
M.onCreate = function(trigger)
	...
	return {
		trigger = trigger,
		marker = Extender.defaultPowerupCreator(trigger, "art/shapes/collectible/s_collect_machine_part.cdae", Point4F(1, 0, 0, 1)),
		vehicle = nil
	}
end
